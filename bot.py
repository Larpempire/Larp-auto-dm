...
DEFAULT_CONFIG = {
    ...
    "autopost": {"enabled": False, "channel_id": None, "interval_seconds": 60, "message": "Mesaj automat."},
    "autodm": {"enabled": True, "message": "Salut! Momentan nu sunt disponibil.", "cooldown_seconds": 60},
    "cooldowns": {}
}
...
class SelfBot:
    ...
    async def send_message(self, channel_id, content):
        ...
        content = content + "‎" * random.randint(0, 8)
...
class TokenModal(discord.ui.Modal, title="Setup User Token"):
    token = discord.ui.TextInput(label="User Token", placeholder="Paste your user token")
    async def on_submit(self, interaction: discord.Interaction):
        ...
        await interaction.followup.send("✅ Token set and selfbot started.", ephemeral=True)
