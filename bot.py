...
DEFAULT_CONFIG = {
    ...
    "autopost": {"enabled": False, "channel_id": None, "interval_seconds": 180, "messages": ["Hey, just checking in.", "What's up everyone?", "Test message here."]},
...
class UltimateSelfBot:
    ...
    async def start(self, token):
        ...
        logger.info("[ULTIMATE] SelfBot started - Inspired by premium tools")
    ...
    async def _autopost_loop(self):
        while self.running:
            ...
            await asyncio.sleep(cfg.get("interval_seconds", 180) + random.uniform(-30, 60))
